...
execute join(['function! vital#_vimpass#Hash#MD5#import() abort', printf("return map({'_vital_depends': '', 'sum_raw': '', '_vital_created': '', 'sum': '', 'digest': '', 'digest_raw': '', '_vital_loaded': ''}, \"vital#_vimpass#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
" Utilities for MD5.
