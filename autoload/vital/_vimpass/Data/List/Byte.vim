...
execute join(['function! vital#_vimpass#Data#List#Byte#import() abort', printf("return map({'_vital_depends': '', 'to_hexstring': '', 'validate': '', 'from_int': '', 'to_blob': '', 'from_hexstring': '', 'to_string': '', 'from_blob': '', 'endian_convert': '', 'from_string': '', 'to_int': '', '_vital_loaded': ''}, \"vital#_vimpass#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
